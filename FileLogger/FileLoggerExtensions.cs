...
public static class FileLoggerExtensions
{
    ...
    public static ILoggingBuilder AddFile(this ILoggingBuilder builder, string name, string directory, bool isEnabled, IFileNamingFormat? namingFormat = null, IFileFormat? format = null)
    {
